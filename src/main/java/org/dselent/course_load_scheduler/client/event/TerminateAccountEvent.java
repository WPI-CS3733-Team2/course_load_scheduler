...
public class TerminateAccountEvent extends DisplayEvent<TerminateAccountAction, TerminateAccountEventHandler>{
...
public static Type<TerminateAccountEventHandler> TYPE = new Type<TerminateAccountEventHandler>();
	...
	public TerminateAccountEvent(TerminateAccountAction action, HasWidgets container)
	{
		//this.action = action;
